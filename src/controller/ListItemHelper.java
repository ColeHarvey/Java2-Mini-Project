...
public class ListItemHelper {
	...
	public void deleteItem(ListItem toDelete) {
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
		TypedQuery<ListItem>typedQuery = em.createQuery("SELECT li FROM ListItem li WHERE "
				+ "li.store = :selectedStore and li.item = :selectedItem", ListItem.class);
	...
	public List<ListItem> searchForItemByStore(String storeName) {
		...
		TypedQuery<ListItem> typedQuery = em.createQuery("SELECT li FROM ListItem"
				+ " li WHERE li.store = :selectedStore", ListItem.class);
	...
	public List<ListItem> searchForItemByItem(String itemName) {
		...
		em.getTransaction().begin();
		TypedQuery<ListItem> typedQuery = em.createQuery("SELECT li FROM ListItem"
				+ " li WHERE li.item = :selectedItem", ListItem.class);
